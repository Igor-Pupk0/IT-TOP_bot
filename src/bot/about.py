...
async def handle_message(message: aiogram.types.Message):
    ...
    await message.answer(
        text=f"""\
Этот бот создан для того, чтобы сделать взаимодействие с функциями журнала более простым и быстрым, ну или расширить их. Его создал первокурсник из группы кибербезопасности с Красноярска. \
...
Сюда мне можно написать всякие пожелания, про баги или идеи для функционала: <a href='t.me/{SUPPORT_USERNAME}'>Кликабельно</a>
